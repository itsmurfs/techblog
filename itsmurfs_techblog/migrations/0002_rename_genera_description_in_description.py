...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename 'genera_description' field to 'description'
        db.rename_column('itsmurfs_techblog_mention', 'genera_description', 'description')

    def backwards(self, orm):
        # Rename 'description' field to 'genera_description'
        db.rename_column('itsmurfs_techblog_mention', 'description', 'genera_description')
